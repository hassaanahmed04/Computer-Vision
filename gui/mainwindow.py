...
class App(customtkinter.CTk):
    ...
    def camera_mode_dialog(self):
        dialog = customtkinter.CTkToplevel(self)
        dialog.title("Select Camera Mode")
        ...
        label = customtkinter.CTkLabel(dialog, text="Choose camera setup:")
        label.pack(pady=20)
        ...
        single_btn = customtkinter.CTkButton(button_frame, text="Single Camera", command=lambda: choose("single"))
        single_btn.pack(side="left", padx=10)

        double_btn = customtkinter.CTkButton(button_frame, text="Double Camera", command=lambda: choose("double"))
        double_btn.pack(side="right", padx=10)
